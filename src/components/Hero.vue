...
<template>
  <div class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0">
      <div class="absolute inset-0 bg-background/60 z-10 backdrop-blur-[2px]"></div>
      <img
        src="https://images.unsplash.com/photo-1642391350894-3040b7cad8bf?auto=format&fit=crop&q=80"
    ...
    <div
      ...
      :style="{
        transform: `perspective(1000px) rotateX(${tilt * 10}deg) rotateY(${
          roll * 10
        }deg)`,
    ...
    >
      ...
      <p class="text-xl md:text-2xl text-accent-gray mb-12 max-w-2xl mx-auto">
        Experience the vibrant flavors of Colombia in Los Angeles, where every
        bite tells a story of tradition and taste.
      </p>
      <div class="space-x-4">
        <a
          href="#menu"
