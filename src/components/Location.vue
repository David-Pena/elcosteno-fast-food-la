...
<template>
  <section id="location" ref="locationRef" class="py-20 bg-background/50">
    <div class="max-w-5xl mx-auto px-4">
      ...
      <div class="grid md:grid-cols-2 gap-6" :class="{ 'animate-slide-up': isVisible }">
        <!-- Address Card -->
        <div class="bg-background border border-accent-gray/20 rounded-lg p-8 hover:border-primary/50 transition-all duration-300">
          <div class="flex items-start space-x-4">
            ...
            <div>
              ...
              <p class="text-accent-gray">{{ location.city }}, {{ location.state }} {{ location.zip }}</p>
            </div>
          </div>
        </div>
        ...
        <!-- Contact Card -->
        <div class="md:col-span-2 max-w-md mx-auto w-full bg-background border border-accent-gray/20 rounded-lg p-8 hover:border-primary/50 transition-all duration-300">
          <div class="flex items-start space-x-4">
            <div class="flex-shrink-0">
              <div class="p-3 bg-tertiary bg-opacity-10 rounded-full">
                <svg class="w-6 h-6 text-tertiary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
